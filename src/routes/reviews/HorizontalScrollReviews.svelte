<script lang="ts">
	...
	function horizScroll(e: MouseEvent, index: number, to = 'right') {
		e.preventDefault();
...
<section
	class="mt-16 flex overflow-x-scroll scroll-smooth rounded-xl bg-[#f0efef] py-5 scrollbar-hide dark:bg-[#312e44] {_class}"
>
	<!-- {$$props.class} -->
