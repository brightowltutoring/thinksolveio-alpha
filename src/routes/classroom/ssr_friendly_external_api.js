// fixed SSR error!! Added line 5; changed 'self' to 'globalThis' in line 13
	...
	(() => {
		var e = {
				537: (e, t, n) => {
					...
					function h(e) {
						...
						if (
							...
							(i = n.exec(e)),
							i && ((t.protocol = i[1].toLowerCase()), (e = e.substring(n.lastIndex))),
							(n = new RegExp('^(//[^/?#]+)', 'gi')),
							(i = n.exec(e)),
							i)
						) {
							...
							-1 !== o && ((t.port = r.substring(o + 1)), (r = r.substring(0, o))),
								(t.hostname = r);
						}
						if (
							((n = new RegExp('^([^?#]*)', 'gi')),
					...
					function g(e) {
						...
						s && c.set('jwt', s);
						const { defaultLanguage: d } = e.configOverwrite || {};
						(o || d) && c.set('lang', o || d), a && c.set('release', a);
						const p = c.toString();
						p && (n.search = `?${p}`);
						let { hash: g } = n;
						...
						constructor() {
							...
							(this.postis = (function (e) {
								var t,
									...
									u = function (e) {
										...
										if ((!s || e.origin === s) && t && t.postis && t.scope === n) {
											var i = o[t.method];
											if (i) for (var r = 0; r < i.length; r++) i[r].call(null, t.params);
								...
								var h = {
										...
										send: function (e) {
											var t = e.method;
											(d || e.method === l) && i && 'function' == typeof i.postMessage
												? i.postMessage(
														JSON.stringify({ postis: !0, scope: n, method: t, params: e.params }),
														'*'
													)
												: a.push(e);
										},
								...
								return (
									(t = setInterval(function () {
										h.send({ method: l, params: p });
									}, 50)),
									h.listen(l, function (e) {
										if (e === p) {
											clearInterval(t), (d = !0);
											for (var n = 0; n < a.length; n++) h.send(a[n]);
											a = [];
										} else h.send({ method: l, params: e });
									}),
									h
								);
							})({ ...m, ...e })),
							...
							if (e.type === _) {
								...
								e.type === y
									? this.emit('request', e.data, (t, n) => {
											this._backend.send({ type: _, error: n, id: e.id, result: t });
										})
						...
						sendRequest(e) {
							...
							return new Promise((n, i) => {
								this._responseHandlers.set(t, (e) => {
									...
									void 0 !== r
										? n(r)
										: i(void 0 !== t ? t : new Error('Unexpected response format!'));
								}),
					...
					function S(e) {
						let t;
						return (
							'string' == typeof e && null !== String(e).match(/([0-9]*\.?[0-9]+)(em|pt|px|%)$/)
								? (t = e)
					...
					class j extends r() {
						constructor(e) {
							...
							(this._parentNode = c),
								(this._url = (function (e) {
									...
									devices: f,
									userInfo: y,
									appData: { localStorageContent: k },
									release: w
								})),
								this._createIFrame(a, s, p, L),
						...
						_createIFrame(e, t, n, i) {
							const r = `jitsiConferenceFrame${O}`;
							(this._frame = document.createElement('iframe')),
								(this._frame.allow =
									'camera; microphone; display-capture; autoplay; clipboard-write; hid'),
								(this._frame.name = r),
								(this._frame.id = r),
								this._setSize(e, t),
								this._frame.setAttribute('allowFullScreen', 'true'),
								(this._frame.style.border = 0),
								i && (this._frame.sandbox = i),
						...
						_getPrejoinVideo() {
							const e = this.getIFrame();
							if (this._isPrejoinVideoVisible && e && e.contentWindow && e.contentWindow.document)
						...
						_setSize(e, t) {
							...
							void 0 !== n && ((this._height = e), (this._frame.style.height = n)),
								void 0 !== i && ((this._width = t), (this._frame.style.width = i));
						}
						_setupListeners() {
									...
									case 'video-conference-joined':
										if (void 0 !== this._tmpE2EEKey) {
											...
											this.executeCommand(
												...
												JSON.stringify({ exportedKey: e(this._tmpE2EEKey), index: 0 })
											),
												(this._tmpE2EEKey = void 0);
										}
										(this._myUserID = i),
											(this._participants[i] = { email: n.email, avatarURL: n.avatarURL });
									case 'participant-joined':
										(this._participants[i] = this._participants[i] || {}),
											(this._participants[i].displayName = n.displayName),
											(this._participants[i].formattedDisplayName = n.formattedDisplayName),
											R(this, 1);
										break;
						...
						isModerationOn(e) {
							return this._transport.sendRequest({ name: 'is-moderation-on', mediaType: e });
						}
						...
						setAudioInputDevice(e, t) {
							return (function (e, t, n) {
								return k(e, { id: n, kind: 'audioinput', label: t });
							})(this._transport, e, t);
						}
						setAudioOutputDevice(e, t) {
							return (function (e, t, n) {
								return k(e, { id: n, kind: 'audiooutput', label: t });
							})(this._transport, e, t);
						}
						...
						setVideoInputDevice(e, t) {
							return (function (e, t, n) {
								return k(e, { id: n, kind: 'videoinput', label: t });
							})(this._transport, e, t);
						}
						startRecording(e) {
						...
						async setMediaEncryptionKey(e) {
							...
							if (t) {
								...
								this.executeCommand(
									'setMediaEncryptionKey',
									JSON.stringify({ exportedKey: Array.from(new Uint8Array(e)), index: n })
								);
							} else
								this.executeCommand(
									'setMediaEncryptionKey',
				...
				571: (e, t) => {
					...
					(t.parse = function (e) {
						const i =
								'object' == typeof (arguments.length <= 1 ? void 0 : arguments[1]) &&
					...
					(r.prototype.stringify = function (e) {
						...
						(r.prototype._reschedulePublishInterval = function () {
							this.storeLogsIntervalID &&
								(window.clearTimeout(this.storeLogsIntervalID), (this.storeLogsIntervalID = null)),
				...
				7: (e) => {
					...
					function r() {
						...
						var i = null;
						return (
							n[3] && (i = n[3].match(/\s*at\s*(.+?)\s*\((\S*)\s*:(\d*)\s*:(\d*)\)/)),
							!i || i.length <= 4
								? (0 === n[2].indexOf('log@')
					...
					function s() {
						...
						if (!(t[s] < e.level))
							for (
								var a = !(e.options.disableCallerInfo || i.disableCallerInfo) && r(),
								...
								if (u && 'function' == typeof u) {
									...
									h.push(new Date().toISOString()),
										e.id && h.push('[' + e.id + ']'),
										a && a.methodName.length > 1 && h.push('<' + a.methodName + '>: ');
									var p = h.concat(o);
									u.bind(l).apply(l, p);
								}
							}
